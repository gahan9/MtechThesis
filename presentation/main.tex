...
\input{content/phase1-hotspot.tex}

\section{Phase 2: Analysis and gathering detailed information of the problem}
\input{content/phase2-analysis.tex}

\section{Requirement Specification}
\input{content/requirement-specification-beta.tex}

\section{Why JSON?}
\input{content/why-json.tex}

\section{Implementation of Parsing}
\input{content/implementation-parsing.tex}

\section{Future Scope}
\input{content/future-scope-interim.tex}
